...
export default function SearchBar(queryProp?: {
    ...
    return (
        <motion.div
            ...
            layoutId="search-bar"
            className={cn(
                "flex items-center w-[90vw] lg:w-[50%] py-2 rounded-full shadow-2xl border-1 border-bg-light bg-bg-medium",
                className
            )}>
            ...
            <input
                ...
                className="flex-grow font-medium bg-transparent placeholder-text-light focus:outline-none"
